...
<section class="container-fluid">
  <div class="row d-flex justify-content-center">
    <div class="col-md-6 bg-light card border  bt border-primary">
      <form role="form" method="POST" action="{{route('participa.usuario',$id)}}">
        ...
        <div class="form-group">
          ...
          <input type="emailr" class="form-control" id="mail" min="1" name="email" placeholder="Ingrese su email" required>
        </div>

        <div class="form-group">
          <label for="titulo">rut</label>
          <input type="text" class="form-control" id="rut" min="0" name="rut" placeholder="indique su rut sin - ni ." required>
